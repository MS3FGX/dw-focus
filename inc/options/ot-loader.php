  ...
  class OT_Loader {
    ...
    public function constants() {
      ...
      if ( false == OT_THEME_MODE ) {
        ...
        define( 'OT_DIR', trailingslashit( get_template_directory() ) .'/inc/'. trailingslashit( basename( dirname( __FILE__ ) ) ) );
        define( 'OT_URL', trailingslashit( get_template_directory_uri() )  .'/inc/'.  trailingslashit( basename( dirname( __FILE__ ) ) ) );
      }
