      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $categories ) ) {
          ...
          foreach ( $categories as $category ) {
            ...
            echo '<option value="' . esc_attr( $category->term_id ) . '"' . selected( $field_value, $category->term_id, false ) . '>' . $indent . esc_attr( $category->name ) . '</option>';
          }
        } else {
  ...
  function ot_type_number( $args = array() ) {
    ...
    echo '<div class="format-setting type-text ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* build text input */
        echo '<input type="number" name="' . esc_attr( $field_name ) . '" id="' . esc_attr( $field_id ) . '" value="' . esc_attr( $field_value ) . '" class="small-text option-tree-ui-input ' . esc_attr( $field_class ) . '" />';
